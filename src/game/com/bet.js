//押注和自动投
{
    ...
    class Bet extends ui.Game.BetUI{
        ...
        update (data) {
            ...
            var defaultBet =  GM.CookieUtil.get("defaultBet"+ GM.gameId+GM.user_id) ? parseInt(GM.CookieUtil.get("defaultBet"+GM.gameId+GM.user_id),10): null;
            if(defaultBet && defaultBet<= data.total ){
                     this.betValue.text = defaultBet;
                     this.playValue = defaultBet;
            }else{               
        ...
        playGame(){   
             ...
             Laya.timer.once(1000, this, function () {
                ...
                GM.CookieUtil.set("defaultBet"+ GM.gameId + GM.user_id,String(this.playValue));
