...
/******/ 	var hotCurrentHash = "82f283648f7b9be3063d"; // eslint-disable-line no-unused-vars
...
/* 0 */
/*!******************************!*\
  !*** multi ./script/main.js ***!
  \******************************/
/*! no static exports found */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\Users\liujiaojiao889\Desktop\workall\新版摇一摇\yaoyiyao\script\main.js */1);
...
__webpack_require__(/*! ./start/scene.js */ 2);
...

{
    ...
    var StartScene = function (_Sail$Scene) {
        _inherits(StartScene, _Sail$Scene);
        ...
        _createClass(StartScene, [{
            ...
            value: function init() {
                ...
                Sail.io.emit(GAME_CMDS.USE_INFO, null, "ajax");
            ...
            key: "showStaticProgress",
            value: function showStaticProgress() {

                var proPreLoad = new Com.Start.PreLoad();
                this.proPreLoad = proPreLoad;
                this.addChild(proPreLoad);
            }
        }, {
            key: "checkLogin",
            value: function checkLogin(data, cmd) {
            ...
            value: function onExit() {
                this.destroy(true);
                Sail.io.unregister(GAME_CMDS.USE_INFO, this, this.checkLogin);
            }
        }, {
            key: "onResize",
